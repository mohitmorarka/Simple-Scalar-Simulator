...
#include "cache.h"
#include <assert.h>
extern float VSF;//cs203A
extern float FSF;//cs203A
...
extern int DVFSInterval;//cs203A
int nvreg_width;
int npreg_width;
...
float total_cycle_power_total;//cs203A
float total_cycle_power_average;//cs203A
...
void update_power_stats()
{
  ...
  Powerfactor1 = FSF*pow(VSF,2);//cs203A updating the power factor with new values of FSF and VSF from DVFS.c
  
  total_cycle_power_cc1 += clock_power_cc1;
  total_cycle_power_cc2 += clock_power_cc2;
  total_cycle_power_cc3 += clock_power_cc3;
  //cs203A calculating the total cycle power
  total_cycle_power_total = (float)((total_cycle_power_cc1 + total_cycle_power_cc2 + total_cycle_power_cc3)*Powerfactor1);
  //cs203A calculating the average cycle power
  total_cycle_power_average = (float)(total_cycle_power_total/DVFSInterval);
     ...
     int cache;
{
  ...
  */
  ...
  //fprintf(stderr,"Power facor mohit == %g\n",Powerfactor);
